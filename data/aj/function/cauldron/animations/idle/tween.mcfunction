...
tag @s add aj.cauldron.animation.idle.playing
...
execute at @s run function aj:cauldron/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:cauldron/animations/idle/zzz/apply_frame {frame: $(to_frame)}
