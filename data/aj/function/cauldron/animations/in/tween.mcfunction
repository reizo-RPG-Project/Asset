...
tag @s add aj.cauldron.animation.in.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.in.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:cauldron/animations/in/zzz/apply_frame {frame: 0}
$execute at @s run function aj:cauldron/animations/in/zzz/apply_frame {frame: $(to_frame)}
