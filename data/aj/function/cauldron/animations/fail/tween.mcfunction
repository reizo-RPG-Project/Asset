...
function aj:cauldron/animations/pause_all
tag @s add aj.cauldron.animation.fail.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.fail.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:cauldron/animations/fail/zzz/apply_frame {frame: 0}
$execute at @s run function aj:cauldron/animations/fail/zzz/apply_frame {frame: $(to_frame)}
