...
# どっちも素手だったら吐き出す
execute if data storage reizo_mcfunc_engin:context this.PlayingRecordData unless items entity @a[tag=RPG.Obj.0017.PlayPlayer] weapon.* stick[custom_data~{Item:{Field:{RecordData:{}}}}] run function rpg:asset/object/0017.jukebox/tick/back_record.m with storage reizo_mcfunc_engin:context this.PlayingRecordData
