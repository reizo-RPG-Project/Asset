#> rpg:asset/object/0013.spawner_0003/register
#
# 
#
...
# フィールド
    # 何回召喚できるか Int型
    data modify storage reizo_mcfunc_engin:object Field.HP set value 2
    # 本気になるのか？ boolean型
    data modify storage reizo_mcfunc_engin:object Field.Seriously set value 1b
    # スポナーが敵対状態に入る範囲 Int型
    data modify storage reizo_mcfunc_engin:object Field.in_hostil.range set value 6
    # どのmobを召喚するか。 unknow型
    data modify storage reizo_mcfunc_engin:object Field.SpawnMob set value ["0006.zombie_kid"]
