...
# 追加mobをリストに追加する
    ...
    data modify storage reizo_mcfunc_engin:context this.SpawnMob append value "0006.zombie_kid"
    # 盗賊:0004
    data modify storage reizo_mcfunc_engin:context this.SpawnMob append value "0004.thief"