...
# 条件を満たしているのなら演出を
execute if entity @p[distance=..8] if data entity @s {OnGround:1b} unless entity @e[type=item,distance=..0.8,tag=!This] if data storage reizo_mcfunc_engin:object 0002.private{is_move:1b} run function rpg:asset/object/0002.item/tick/fx/run.m with storage reizo_mcfunc_engin:context data.Field.FX
