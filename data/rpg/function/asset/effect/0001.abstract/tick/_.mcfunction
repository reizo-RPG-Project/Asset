...
#> UIデータを作成
    ...
    # 追加
        data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].UI.Effect append value [{"text":"\uF822",font:"space"},{"text":"icon",font:"icon/effects",shadow_color:0}]
        data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].UI.Effect[-1][-1].text set from storage reizo_mcfunc_engin:context this.Init.UI.Icon