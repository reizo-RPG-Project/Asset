#> rpg:asset/effect/0007.determination/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:effect Register.Name set value {"text":"ケツイ"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:effect Register.Lore set value [{"text":"ケツイが みなぎった。"}]
    # 残り時間 Int型
    data modify storage reizo_mcfunc_engin:effect Register.Duration set value 1

#> フィールド
    # IconID String型
    data modify storage reizo_mcfunc_engin:effect Field.IconID set value "0006"