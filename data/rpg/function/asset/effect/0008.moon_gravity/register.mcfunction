#> rpg:asset/effect/0008.moon_gravity/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:effect Register.Name set value {"text":"ムーン・グラビティ"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:effect Register.Lore set value [{"text":""}]
    # 残り時間 Int型
    data modify storage reizo_mcfunc_engin:effect Register.Duration set value 40

#> フィールド
    # IconID String型
    data modify storage reizo_mcfunc_engin:effect Field.IconID set value "0007"