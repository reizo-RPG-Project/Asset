...
# フィルターをかける
execute as @e[tag=reizo_mcfunc_Engin.Mob,tag=RPG.Mob.0007.NPC,distance=..25] run function rpg:asset/mob/0007.abstract_npc/trigger/core/interacted/filters/7
