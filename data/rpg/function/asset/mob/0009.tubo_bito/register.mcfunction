...
#> フィールド
    ...
    # 出すアイテム
    data modify storage reizo_mcfunc_engin:mob Field.Items append value [{Rarity:1,List:["0004.wooden_sword"]},{Rarity:2,List:["0016.stone_sword","0030.copper_sword","0035.sharp_bone"]}]
