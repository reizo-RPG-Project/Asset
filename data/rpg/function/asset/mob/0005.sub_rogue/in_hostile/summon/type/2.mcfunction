#> rpg:asset/mob/0005.sub_rogue/in_hostile/summon/type/2
#
# 
#
...
# 回数をランダムに決める
    execute store result storage reizo_mcfunc_engin:context this.SummonCount.zombie int 1 run random value 0..2
