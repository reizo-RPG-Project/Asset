...
tag @e[tag=reizo_mcfunc_Engin.Mob,tag=RPG.Mob.0002.Enemy,distance=..0] add RPG.Mob.0005.Illusion

# スコアで結びつけ
scoreboard players operation @e[tag=reizo_mcfunc_Engin.Mob,tag=RPG.Mob.0002.Enemy,distance=..1] reizo_mcfunc_Engin.ScoreID = @s reizo_mcfunc_Engin.ScoreID
