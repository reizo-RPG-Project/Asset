#> rpg:asset/mob/0014.npc_skull/register
#
# Mobの登録処理
#
...
#> データ登録
    ...
    # 名前 String型
    data modify storage reizo_mcfunc_engin:mob Register.Name set value "スカル"

#> フィールド
    # 話す内容 boolean型(もしかしたらListにして何Tickにどの会話が出るかをここから調整出来るかも。)
    data modify storage reizo_mcfunc_engin:mob Field.Talk set value 1b
    # TalkスコアのID String型
    data modify storage reizo_mcfunc_engin:mob Field.Score set value "0014"