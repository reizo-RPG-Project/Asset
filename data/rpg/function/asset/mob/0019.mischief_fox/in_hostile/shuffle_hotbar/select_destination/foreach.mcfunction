#> rpg:asset/mob/0019.mischief_fox/in_hostile/shuffle_hotbar/select_destination/foreach
#
# 
#
...
# 残るなら再帰
execute if score $Mob.0019.ShuffleCountTemp RPG.Temp matches 1.. run function rpg:asset/mob/0019.mischief_fox/in_hostile/shuffle_hotbar/select_destination/foreach