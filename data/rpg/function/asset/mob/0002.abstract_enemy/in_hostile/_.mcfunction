...
# これが俺の...本気だ！
execute if data storage reizo_mcfunc_engin:context this{Seriously:1b} if score @s RPG.Mob.0002.SeriouslyValue >= @s RPG.HP run function reizo_mcfunc_engin:api/call/_protected.m {Type:"mob",Method:"in_seriously/_"}
