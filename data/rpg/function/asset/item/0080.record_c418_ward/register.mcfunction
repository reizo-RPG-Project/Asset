#> rpg:asset/item/0080.record_c418_ward/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"C418 - ward"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.far"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0010"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 5020
    # レア度
