#> rpg:asset/item/0070.sunglasses/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"サングラス"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"熱い太陽の下でも大丈夫",color:"gray",italic:0b}]
...
# フィールド
    ...
    # ComboID
    # data modify storage reizo_mcfunc_engin:item Field.ComboID set value 0
    # DEF
    data modify storage reizo_mcfunc_engin:item Field.DEF set value 3
    # INT
    data modify storage reizo_mcfunc_engin:item Field.INT set value 2