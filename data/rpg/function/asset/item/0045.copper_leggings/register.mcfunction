...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"銅のレギンス",color:"white"}
...
# フィールド
    ...
    # 最大体力
    data modify storage reizo_mcfunc_engin:item Field.HP_MAX set value 4