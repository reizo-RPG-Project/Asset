#> rpg:asset/item/0031.copper_helmet/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"銅賞を侮るな！",color:"gray",italic:0b}]
...
# フィールド
    ...
    # 最大体力
    data modify storage reizo_mcfunc_engin:item Field.HP_MAX set value 3