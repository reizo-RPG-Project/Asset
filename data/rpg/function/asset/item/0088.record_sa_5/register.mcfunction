#> rpg:asset/item/0088.record_sa_5/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"Samuel Åberg - 5"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.5"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0018"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3560
    # レア度
