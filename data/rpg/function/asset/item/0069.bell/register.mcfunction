#> rpg:asset/item/0069.bell/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"鐘"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"どこまでも鳴り響け！",color:"gray",italic:0b},{"text":"攻撃を喰らえば食らうほどステータスが上昇する。(予定)",color:"gray",italic:0b}]
...
# フィールド
    ...
    # DEF
    data modify storage reizo_mcfunc_engin:item Field.DEF set value 7