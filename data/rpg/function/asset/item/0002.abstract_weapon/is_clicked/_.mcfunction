...
# Hitしたやつへの処理
execute as @e[tag=reizo_mcfunc_Engin.Mob,tag=RPG.Mob.0002.Enemy,tag=RPG.Mob.0002.Hit,type=!player,distance=..32] run function reizo_mcfunc_engin:api/call/_protected.m {Type:"item",Method:"hit/_"}
