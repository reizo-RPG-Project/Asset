#> rpg:asset/item/0032.copper_chest/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"銅の胸当て",color:"white"}
...
# フィールド
    ...
    # DEF
    data modify storage reizo_mcfunc_engin:item Field.DEF set value 36
    # 最大体力
    data modify storage reizo_mcfunc_engin:item Field.HP_MAX set value 6