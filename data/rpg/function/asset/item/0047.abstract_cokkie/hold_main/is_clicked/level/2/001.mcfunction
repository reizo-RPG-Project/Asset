#> rpg:asset/item/0047.abstract_cokkie/hold_main/is_clicked/level/2/001
#
# 
#
# @within function rpg:asset/item/0047.abstract_cokkie/hold_main/is_clicked/level/2/run.m
