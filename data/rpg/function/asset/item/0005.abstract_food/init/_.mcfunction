...
# 回復量
    data modify entity @s Item.components."minecraft:lore" append value [{text:"\uE000",font:"icon/_",color:"white",italic:0b},{text:"回復量: ",color:"white",italic:0b,font:"default"},{"text":"+",color:"green",italic:0b,font:"default"},{"text":"0",color:"green",italic:0b,font:"default"}]
