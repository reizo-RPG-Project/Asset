#> rpg:asset/item/0005.abstract_food/used/recovery/hp
#
# 
#
...
# 回復処理
    execute store result score $Item.0005.Recovery RPG.Temp run data get storage reizo_mcfunc_engin:context this.Recovery.HP
