#> rpg:asset/item/0053.abstract_sime_boots/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Extends append value {ID:"0002.merge_lore",namespace:"reizo_mcfunc_engin"}
    # 継承されないかどうか。 boolean型
    ...
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"足がヌメヌメする...",color:"gray",italic:0b}]
...
#> フィールド
    # 除外したいクラス
    data modify storage reizo_mcfunc_engin:item Field.Merge.Lore.classBlockList append value {ID:"0001.abstract_item",namespace:"rpg"}