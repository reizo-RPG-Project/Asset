#> rpg:asset/item/0085.record_ac_precipice/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"AaronCherof - Precipice"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.precipice"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0015"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 5980
    # レア度
