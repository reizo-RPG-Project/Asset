#> rpg:asset/item/0076.record_c418_mall/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"C418 - mall"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.mall"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0006"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3940
    # レア度
