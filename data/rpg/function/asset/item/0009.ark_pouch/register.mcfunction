#> rpg:asset/item/0009.ark_pouch/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value [{"text":"\uE005",font:"icon/_"},{"text":"アークポーチ",font:"default"}]
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"異次元にもちものを保管できるポーチ",color:"gray",italic:0b},{"text":"左手専用",color:"gray",italic:0b}]
    # 消費アイテム
    ...
    data modify storage reizo_mcfunc_engin:item Register.Slot set value ["offhand"]
