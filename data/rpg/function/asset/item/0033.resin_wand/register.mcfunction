#> rpg:asset/item/0033.resin_wand/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"樹脂の杖"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"ペールガーデンでよく取れる樹脂と魔木を使用した杖。",color:"gray",italic:0b},{"text":"強大な心臓の力が込められている...",color:"gray",italic:0b}]
...
# フィールド
    ...
    # 魔法攻撃力
    data modify storage reizo_mcfunc_engin:item Field.INT set value 14
    # 攻撃速度
