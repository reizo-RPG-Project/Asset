#> rpg:asset/item/0073.record_c418_blocks/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"C418 - blocks"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 6900
    # レア度
