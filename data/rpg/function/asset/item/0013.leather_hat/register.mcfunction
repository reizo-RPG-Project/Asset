#> rpg:asset/item/0013.leather_hat/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"革のぼうし"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"「かわ」いいぼうしだな！",color:"gray",italic:0b}]
...
# フィールド
    ...
    # DEF
    data modify storage reizo_mcfunc_engin:item Field.DEF set value 4
    # SPD
    data modify storage reizo_mcfunc_engin:item Field.SPD set value 1