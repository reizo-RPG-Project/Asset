#> rpg:asset/item/0068.baked_apple/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"焼きリンゴ"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"調理されたリンゴ",color:"gray",italic:0b},{"text":"焼かれても甘さは残っている。",color:"gray",italic:0b}]
...
# フィールド
    ...
    # 回復量
    data modify storage reizo_mcfunc_engin:item Field.Recovery.HP set value 11
    # いつでも食べられるかどうか
