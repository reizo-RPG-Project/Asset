#> rpg:asset/item/test.armor_head/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"test.armor_head"}
...
# フィールド
    ...
    # DEF
    data modify storage reizo_mcfunc_engin:item Field.DEF set value 100