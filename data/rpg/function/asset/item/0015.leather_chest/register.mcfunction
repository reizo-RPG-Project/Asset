#> rpg:asset/item/0015.leather_chest/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"革の上着"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"いわゆる、革ジャンってやつだな！",color:"gray",italic:0b}]
