#> rpg:asset/item/0039.gemingu_manzyuu/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"七色まんじゅう"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"七色に光り輝いている！！！",color:"gray",italic:0b},]
...
# フィールド
    ...
    # 回復量
    data modify storage reizo_mcfunc_engin:item Field.Recovery.HP set value 9
    # いつでも食べられるかどうか
