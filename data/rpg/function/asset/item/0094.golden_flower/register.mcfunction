#> rpg:asset/item/0094.golden_flower/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"きんいろの はな"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"なんの やくにも たたない ただの はなだ。",color:"gray",italic:0b},{"text":"でも てを のばすと...",color:"gray",italic:0b}]
...
# フィールド
    ...
    # エフェクト
    data modify storage reizo_mcfunc_engin:item Field.Effects append value {"ID":"0007.determination",namespace:"rpg"}