#> rpg:asset/item/0082.record_lr_creator_music_box/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"LenaRaine - Creator MusicBox"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.creator_music_box"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0012"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 1460
    # レア度
