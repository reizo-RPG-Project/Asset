#> rpg:asset/item/0086.record_lr_otherside/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"LenaRaine - otherside"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.otherside"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0016"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3900
    # レア度
