...
# そのステータスが存在するのなら追加
    ...
    execute if data storage reizo_mcfunc_engin:context this.HP_regen run function rpg:asset/item/0001.abstract_item/init/lore/hp_regen
    ...
    execute if data storage reizo_mcfunc_engin:context this.MP_regen run function rpg:asset/item/0001.abstract_item/init/lore/mp_regen
