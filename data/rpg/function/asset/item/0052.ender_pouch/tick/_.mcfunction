...
execute if entity @s[tag=!RPG.Obj.0012.Open] positioned ~ ~1.1 ~ run function reizo_mcfunc_engin:api/object/summon.m {ID:"0012.ender_pouch_storage",namespace:"rpg"}
