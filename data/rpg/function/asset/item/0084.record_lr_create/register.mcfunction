#> rpg:asset/item/0084.record_lr_create/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"LenaRaine - Creator"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.creator"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0014"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3520
    # レア度
