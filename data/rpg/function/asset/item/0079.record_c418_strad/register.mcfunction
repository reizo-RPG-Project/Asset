#> rpg:asset/item/0079.record_c418_strad/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"C418 - strad"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.strad"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0009"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3760
    # レア度
