...
# リセット
    execute if data storage reizo_mcfunc_engin:context data.Field.HP unless score @s RPG.HP_MAX = @s RPG.OriginHP_MAX run scoreboard players operation @s RPG.HP_MAX = @s RPG.OriginHP_MAX
    ...
    tag @s remove RPG.Item.0040.Init