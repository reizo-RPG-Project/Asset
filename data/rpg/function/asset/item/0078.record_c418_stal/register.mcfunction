#> rpg:asset/item/0078.record_c418_stal/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"C418 - stal"}
...
#> フィールド
    ...
    data modify storage reizo_mcfunc_engin:item Field.RecordData.name set value "music_disc.stal"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.IconID set value "\u0008"
    data modify storage reizo_mcfunc_engin:item Field.RecordData.LengthInTick set value 3000
    # レア度
