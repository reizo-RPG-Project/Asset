#> rpg:asset/item/0017.iron_sword/register
#
# 
#
...
#> 登録処理
    ...
    data modify storage reizo_mcfunc_engin:item Register.Name set value {"text":"鉄の剣"}
    # 説明文 (TextComponentsString[])
    data modify storage reizo_mcfunc_engin:item Register.Lore set value [{"text":"伝説のなりそこないだが、信頼度は厚い。",color:"gray",italic:0b}]
